...
// https://plone.com/portal_javascripts/++resource++plone.app.jquerytools.overlayhelpers.js?original=1
...
/* - nodeutilities.js - */
// https://plone.com/portal_javascripts/nodeutilities.js?original=1
...
/* - cookie_functions.js - */
// https://plone.com/portal_javascripts/cookie_functions.js?original=1
...
/* - modernizr.js - */
// https://plone.com/portal_javascripts/modernizr.js?original=1
...
/* - livesearch.js - */
// https://plone.com/portal_javascripts/livesearch.js?original=1
...
/* - ++resource++search.js - */
// https://plone.com/portal_javascripts/++resource++search.js?original=1
...
/* - select_all.js - */
// https://plone.com/portal_javascripts/select_all.js?original=1
...
/* - dragdropreorder.js - */
// https://plone.com/portal_javascripts/dragdropreorder.js?original=1
...
// https://plone.com/portal_javascripts/mark_special_links.js?original=1
...
// https://plone.com/portal_javascripts/collapsiblesections.js?original=1
...
/* - form_tabbing.js - */
// https://plone.com/portal_javascripts/form_tabbing.js?original=1
...
// https://plone.com/portal_javascripts/jquery.highlightsearchterms.js?original=1
...
// https://plone.com/portal_javascripts/first_input_focus.js?original=1
jQuery(function($){if($("form div.error :input:first").focus().length){return}
$("form.enableAutoFocus :input:not(.formTabs):visible:first").focus()});

/* - accessibility.js - */
// https://plone.com/portal_javascripts/accessibility.js?original=1
...
/* - styleswitcher.js - */
// https://plone.com/portal_javascripts/styleswitcher.js?original=1
...
/* - toc.js - */
// https://plone.com/portal_javascripts/toc.js?original=1
...
// https://plone.com/portal_javascripts/collapsibleformfields.js?original=1
...
// https://plone.com/portal_javascripts/++resource++plone.app.discussion.javascripts/comments.js?original=1
...
/* - dropdown.js - */
// https://plone.com/portal_javascripts/dropdown.js?original=1
...
// https://plone.com/portal_javascripts/inline_validation.js?original=1
...
/* - kss-bbb.js - */
// https://plone.com/portal_javascripts/kss-bbb.js?original=1
(function($){
...
$(document).ready(function(){var spinner=$('<div id="ajax-spinner"><img src="/spinner.gif" alt=""/></div>');spinner.appendTo('body').hide();$(document).ajaxStart(function(){spinner.show()});$(document).ajaxStop(function(){spinner.hide()});$('body').delegate('#calendar-next,#calendar-previous','click', function(e){e.preventDefault();var el=$(this);var container=el.parents('.portletWrapper');refreshPortlet(container.data('portlethash'),{data:{month:el.data('month'),year:el.data('year')}});return false});$('.kssPortletRefresh,.refreshPortlet').each(function(){applyPortletTimeout($(this))});$('.portlet-deferred').each(function(){refreshPortlet($(this).parents('.portletWrapper').data('portlethash'))});
